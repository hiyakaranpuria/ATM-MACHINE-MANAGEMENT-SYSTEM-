...
<head runat="server">
    ...
    <meta http-equiv="refresh" content="5;url=WebForm4.aspx" />
    <script type="text/javascript">
        setTimeout(function () {
            window.location.href = 'WebForm5.aspx';
        }, 5000); // Redirects after 5 seconds (5000ms)
    </script>
</head>
<body>
    <div class="container">
        ...
        <div class="message">We are processing your transaction.<br />Do not remove your card until prompted.</div>
